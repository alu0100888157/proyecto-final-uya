      ...
      <div class="col s12 m8 l9"> 
        <div class="card-panel foro">
            <div class="central">
              ...
              <h3 class="center grey-text text-darken-2"><strong tabindex="0">Alumnos Matriculados</strong></h3><hr><br>
              
              <ul class="collection">
                <li class="collection-item avatar">
                  <img src="img/airan.png" alt="imagen alumno airan" class="circle">
                  <span class="title">AIRAN OMAR VILLACORTA BETANCOR</span>
                  <p><b>Correo:</b> airan@uya.hol.es</p>
                </li>
                <li class="collection-item avatar">
                  <img src="img/cristian.jpg" alt="imagen alumno cristian" class="circle">
                  <span class="title">CRISTIAN MANUEL ANGEL DIAZ</span>
                  <p><b>Correo:</b> cristian@uya.hol.es</p>
                </li>
                <li class="collection-item avatar">
                  <img src="img/angel.jpg" alt="imagen alumno angel" class="circle">
                  <span class="title">ANGEL LUIS MORALES HERNANDEZ</span>
                  <p><b>Correo:</b> angel@uya.hol.es</p>
                </li>
                <li class="collection-item avatar">
                  <img src="img/oscar.jpg" alt="imagen alumno oscar" class="circle">
                  <span class="title">OSCAR JESUS SOCAS GONZALEZ</span>
                  <p><b>Correo:</b> oscar@uya.hol.es</p>
                </li>
              </ul>
        		</div>     
        </div>
