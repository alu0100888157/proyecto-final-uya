      ...
      <div class="col s12 m8 l9"> 
        <div class="card-panel foro">
            <div class="central">
              ...
              <h3 class="center grey-text text-darken-2"><strong tabindex="0">Error - Ups Parece que ha habido un error con su usuario o contraseña.</strong></h3><hr><br>

              <p align="justify" tabindex="0">
                Por favor inserte nuevamente sus credenciales.
              </p>

              <p align="justify" tabindex="0">
                Sino dispone de una cuenta, deberá registrarse.
              </p>
